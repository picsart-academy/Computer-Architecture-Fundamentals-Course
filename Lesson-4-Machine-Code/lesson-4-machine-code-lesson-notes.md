...
<img width="1098" alt="image1.png" src="assets/image1.png">
...
The decimal number 47 is converted to its binary representation, which is 00101111. In binary, each digit can have two possible values: 0 or 
* The binary representation follows a positional system, where each digit represents a power of 
* Breaking down the conversion:


<img src="assets/image6.png" width="300" height="200">


* take the decimal number 17 and represent it in binary using an 8-bit representation.

> Step 1: Convert 17 to binary:
>
* Divide 17 by 2 repeatedly until the quotient is 0, noting the remainders:
 
<img src="assets/image3.png" width="300" height="200">


* Reading the remainders from the bottom up, we have: 10001.

  
> Step 2: Pad the binary number to 8 bits:
> Since the binary number 10001 has only 5 digits, we need to add leading zeros to make it an 8-bit representation
> Binary: 00010001


* To convert a **binary** number to its **decimal** representation, you can use the positional value system
...
<img src="assets/image4.svg" width="250" height="200">
...
> 
* Constants:
> Constants are symbols that represent fixed values that do not change during program execution. They are typically defined with a name and ? 
> assigned a specific value that remains constant.
> 
* Labels:
...
The structure of floating-point representation for a binary number typically follows the IEEE 754 standard, which is widely used in modern computing systems. The structure consists of three components: the sign bit, the exponent, and the fraction (mantissa).
...
In the RGB color model, each color channel (red, green, and blue) is typically represented by an 8-bit value ranging from 0 to 255. Here are some examples of RGB colors represented in bytes (8-bit values):
  ...
  <img src="assets/basic-colours.png" alt="Image" style="width:300px; height:200px;">
  <ul>
    <li>Pure Red</li>
    <li>Red: 255</li>
    <li>Green: 0</li>
    <li>Blue: 0</li>
    <li>RGB Byte Representation: (255, 0, 0)</li>
  </ul>
...
File extensions are suffixes attached to the end of a file name, typically separated by a period. They indicate the file's format or type, providing a way for operating systems and applications to recognize and handle files appropriately. 
